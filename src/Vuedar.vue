<template>
    <div class="calendar-dates" id="calendar-dates" :class="{loading: loading}">
        ...
        <!-- @slot {body} Calendar content -->
        <slot name="body">
            <div class="calendar-body">
                <!-- @slot {weekdays} Weekdays on top of calendar -->
                <slot name="weekdays">
                ...
                <slot name="day">
                    <div class="days-month">
                        ...
                        <!-- @bind {object} Dates to highlights in calendar -->
...
export default {
    props: {
         ...
         * @author ER Soluções Web <contato@ersolcuoesweb.com.br>
         */
        years: {
            default: () => [2021, 2022, 2023, 2024, 2025]
        },
    ...
    mounted() {
         ...
         */
        this.selected_month = this.months[this.active_date.getMonth()];
    ...
    watch: {
         ...
         * @name change_year
         * @return Number
         * @description Return selected year
         */
        selected_year() {
            this.$emit('change_year', this.selected_year)
            this.update()
        },
         ...
         * @name change_month
         * @return Number
         * @description Return selected month
         */
        selected_month() {
            this.$emit('change_month', this.selected_month)
            this.update()
        },
         ...
         * @name change_day
         * @return Number
         * @description Return selected day
         */
        selected_day() {
            this.update()
        },
         ...
         * @name change_date
         * @return Date
         * @description Return selected date
         */
        active_date() {
    ...
    methods: {
        ...
        setYear(m, k) {
            ...
            if(this.selected_year == this.today.getFullYear() && this.selected_month_key == this.today.getMonth()) {
        ...
        next() {
            ...
            if(this.selected_month_key > 11) {
                this.selected_month_key = 0
                this.selected_year++
            }
            this.selected_month = this.months[this.selected_month_key]
            this.selected_day = null
